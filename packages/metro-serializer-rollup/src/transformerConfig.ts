...
export const rollupTransformerConfig: Partial<TransformerConfigT> = {
  ...
  /**
   * Minifying is unnecessary as Rollup will take care of it.
   */
  minifierPath: "@rnx-kit/metro-serializer-rollup/lib/minify.js",
